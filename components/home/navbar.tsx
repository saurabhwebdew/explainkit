  ...
  return (
    <header className="fixed top-0 inset-x-0 z-40">
      <div className="max-w-content mx-auto px-4 md:px-6 pt-4">
        <div className="flex items-center justify-between rounded-full border border-line/70 bg-surface/80 backdrop-blur-md shadow-softer px-4 md:px-5 h-14">
        ...
        {open && (
          <motion.nav
            ...
            className="md:hidden mt-2 rounded-2xl border border-line bg-surface shadow-soft p-4 flex flex-col gap-3 text-sm"
          >
            {nav.map((item) => (
